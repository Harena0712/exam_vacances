...
<body class="container">
    ...
    <div class="bg-light col-md-5 rounded mt-4 text-center">
        <h4 class="text-center p-3">Site emprunt</h4>
        <form action="page/traitement_login.php" method="post">
            <input type="texte" class="col-md-10 p-1 rounded" name="" id="" placeholder="   email">
            <input type="password" class="col-md-10 p-1 rounded mt-4" name="" id="" placeholder="   mot de passe">
